...
if page.startswith("Главная"):
    ...
    st.write(f"Любовь моя, с Новым 2026 годом! 🎉 Желаю тебе море счастья, тепла и наших совместных приключений. Пусть этот год принесёт только радость, как твоя улыбка! Я так рад, что встречу его с тобой. ❤️")
